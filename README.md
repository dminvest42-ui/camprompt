...
- Запись видео+звука (H.264/AAC, .mov, 1080p) в папку `Teleprompter` внутри Загрузок/Документов/Фильмов (настраивается), обратный отсчёт, таймер записи, список записей.
